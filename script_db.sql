...
--
-- Base de données :  `poguet_gazette`
--

CREATE USER 'poguet_u'@'localhost' IDENTIFIED BY 'poguet_p';

CREATE DATABASE IF NOT EXISTS `poguet_gazette` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;

GRANT SELECT, INSERT, UPDATE, DELETE ON `poguet_gazette`.* TO "poguet_u"@"localhost";
