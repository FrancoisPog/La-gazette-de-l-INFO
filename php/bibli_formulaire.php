 ...
 */
function fp_print_DatesLine($label,$name,$minYear,$maxYear,$defaultDay = 0, $defaultMonth = 0,$defaultYear = 0,$yearsStep = 1,$tooltip = '',$tooltipInForm=false){
    echo '<tr>',
 ...
 * @param bool $tooltipInForm   True if there is at least one tooltip in the form, else false
 */
function fp_print_inputLine($label,$type,$name,$maxLength = '',$required =true,$placeholder = '',$value = '',$tooltip = '',$tooltipInForm = false){
 ...
 */
function fp_print_inputRadio($name,$values,$required = true,$default = ''){
 ...
 * @param bool $tooltipInForm   True if there is at least one tooltip in the form, else false
 */
function fp_print_inputRadioLine($label,$name,$values,$required = true,$default = '',$tooltip = '',$tooltipInForm = false){
    echo    '<tr>',
                '<td class="label"><label>',$label,'</label></td>',
                '<td class="input" ',($tooltip == '' && $tooltipInForm)?'colspan="2"':'','>',
 ...
 * @param bool $tooltipInForm   True if there is at least one tooltip in the form, else false
 */
function fp_print_checkboxLine($name,$label,$required = true, $checked = false,$tooltip = '', $tooltipInForm = false){
    echo '<tr>',
 ...
 * @param bool $tooltipInForm   True if there is at least one tooltip in the form, else false
 */ 
function fp_print_buttonsLine($submit,$resetValue = '',$tooltipInForm = false){
    if(!is_array($submit)){
